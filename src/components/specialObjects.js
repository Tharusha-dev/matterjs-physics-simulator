  ...
  return (
    ...
    <div className='project-panel'>
      ...
      <div className="spawner-select">
        ...
        <div className="spawner" onClick={() => { setSpawnerClicked(!spawnerClicked); setSpawning(!spawnerClicked) }} style={{ border: spawnerClicked ? "2px solid white" : 0, }}>
        ...
        <div className="spawner-properties" style={{ display: "grid", alignItems: "center" }} >
          ...
          <button onClick={() => {
            ...
            spawnerProperties({body: selectedBody})}} style={{ marginLeft: "1vw" }} >Apply</button>
